...
def collect_cross_sections(name, get_dxs=True):
...
xs, dxs = collect_cross_sections('CT18ANNLO_FONLL-C_pto2_NLL', get_dxs=False)
...
ax.plot(xs_nocharm['E'], xs_nocharm['nu']['i']['charm'], color='m', linewidth=2, label=r'$\nu~\textrm{Charm}$')
ax.plot(xs_nocharm['E'], xs_nocharm['nubar']['i']['charm'], color='m', linewidth=2, linestyle='--', label=r'$\bar{\nu}~\textrm{Charm}$')
...
plt.tight_layout()
plt.savefig('plots/total_cross_section_evolve.pdf')
plt.close()
...
ax.plot(xs_nocharm['E'], xs_nocharm['nu']['i']['charm'] / xs_nocharm['E'], color='m', linewidth=2, label=r'$\nu~\textrm{Charm}$')
ax.plot(xs_nocharm['E'], xs_nocharm['nubar']['i']['charm'] / xs_nocharm['E'], color='m', linewidth=2, linestyle='--', label=r'$\bar{\nu}~\textrm{Charm}$')
...
ax.grid(True, which='Both')
plt.tight_layout()
plt.savefig('plots/total_cross_section_over_E_evolve.pdf')
plt.close()
...
# ax.plot(xs_nocharm['E'], xs_nocharm['nu']['i']['charm'] / xs['nu']['i']['total'], linewidth=2, color='orange', label=r'$\nu~\textrm{w/o c pdf}$')
# ax.plot(xs_nocharm['E'], xs_nocharm['nubar']['i']['charm'] / xs['nubar']['i']['total'], linewidth=2, color='orange', linestyle='--', label=r'$\bar{\nu}~\textrm{w/o c pdf}$')
...
# ax.grid(True, which='Both')
# plt.tight_layout()
# plt.savefig('plots/charm_fraction_evolve.pdf')
# plt.close()
